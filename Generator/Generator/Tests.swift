...
func writeSettings(with elements: [Element]) {
    let SETTINGS_PATH = GENERATED_PATH.appendingPathComponent("Settings.swift")
...
func writeDefinitions(with elements: [Element]) {
    let RECORD_PATH = GENERATED_PATH.appendingPathComponent("Record.swift")
...
func writeInitializations(with elements: [Element]) {
    let INITIALIZATION_PATH = GENERATED_PATH.appendingPathComponent("Initialization.swift")
...
func writeRetrievals(with elements: [Element]) {
    let RETRIEVAL_PATH = GENERATED_PATH.appendingPathComponent("Retrieval.swift")
...
func writeMutations(with elements: [Element]) {
    let MUTATION_PATH = GENERATED_PATH.appendingPathComponent("Mutation.swift")
...
func writePassing() {
    let PASSING_PATH = GENERATED_PATH.appendingPathComponent("Passing.swift")
...
func writeSerializations() {
    let SERIALIZATION_PATH = GENERATED_PATH.appendingPathComponent("Serialization.swift")
...
func writeDeserializations() {
    let DESERIALIZATION_PATH = GENERATED_PATH.appendingPathComponent("Deserialization.swift")
...
func writeSorting(with elements: [Element]) {
    let SORTING_PATH = GENERATED_PATH.appendingPathComponent("Sorting.swift")
