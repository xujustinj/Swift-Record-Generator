...
func structureSorting(by element: Element, mutable: Bool) -> String {
    ...
    return """
    func structure\(mutable ? _Var : _Let)Sorting(\(COUNTER_PARAMETER)) {
        \(mutable ? _var : _let) array = fill(ARRAY_SIZE) { randomRecordStructure() }
